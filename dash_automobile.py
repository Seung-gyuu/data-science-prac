...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        return html.Div([
             html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'display': 'flex', "margin-left": "130px"}),
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={'display': 'flex', "margin-left": "130px"})
            ])
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        x="Year", y="Automobile_Sales", title="Yearly Automobile Sales for the Whole Period"))
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return  html.Div([
                html.Div(className='chart-item', children=[html.Div(children=Y_chart1),html.Div(children=Y_chart2)],style={'display':'flex', "margin-left": "130px"}),
                html.Div(className='chart-item', children=[html.Div(children=Y_chart3),html.Div(children=Y_chart4)],style={'display': 'flex', "margin-left": "130px"})
                ])
    else:
        return None
